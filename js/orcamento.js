...
function getPdvQuickQuantityModal() {
  ...
  modal.innerHTML = `<div class="pdv-quantity-backdrop"></div><section class="pdv-quantity-sheet" role="dialog" aria-modal="true" aria-labelledby="pdv-quantity-title"><div class="sheet-handle"></div><button type="button" class="pdv-quantity-close" aria-label="Fechar"><i class="ph ph-x"></i></button><h3 id="pdv-quantity-title"></h3><p class="pdv-quantity-instruction">Escolha a litragem para continuar.</p><div class="pdv-volume-options"></div><div class="pdv-fragrance-options hidden"></div><div class="pdv-quantity-controls hidden"><label>Quantidade de unidades</label><div class="pdv-quantity-row"><div class="pdv-quantity-stepper"><button type="button" data-pdv-quantity="-1" aria-label="Diminuir">−</button><input id="pdv-quick-quantity-input" type="text" inputmode="numeric" pattern="[0-9]*" value="1" autocomplete="off" data-numeric-only="int"><button type="button" data-pdv-quantity="1" aria-label="Aumentar">+</button></div><div class="pdv-quick-adds"><button type="button" data-pdv-quick-add="1">+1</button><button type="button" data-pdv-quick-add="5">+5</button><button type="button" data-pdv-quick-add="10">+10</button></div></div><button type="button" class="pdv-quantity-confirm">Adicionar ao carrinho</button></div></section>`;
